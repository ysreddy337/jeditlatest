 ...
 *
 * $Id: RegistryParser.cpp,v 1.1 2001/09/05 11:24:52 jgellene Exp $
 */
	...
	: m_bIsInit(FALSE)
{
	...
	// parameter IDS_REG_PARAMS_KEY_3_2 is version-specific
...
BOOL RegistryParser::InitServerPath()
{
	...
	OutputDebugString("Server path is:");
	OutputDebugString(m_strServerPath);
	return TRUE;
}
